...
<body>
  ...
  <br>
	...
	<script>
		<?php foreach($items as $item) {?>
			document.getElementById("<?php echo $item['productID'];?>").onclick = function() {myFunction()};
	...
	document.getElementById("demo9").onclick = function() {myFunction9()};
	document.getElementById("demo10").onclick = function() {myFunction10()};
	document.getElementById("demo11").onclick = function() {myFunction11()};
