...
<script>
	document.getElementById("ISD1").onclick = function() {
		myFunction()
	};
	document.getElementById("ISD2").onclick = function() {
		myFunction2()
	};
	document.getElementById("ISD3").onclick = function() {
		myFunction3()
	};
	document.getElementById("HC1").onclick = function() {
		myFunction4()
	};
	document.getElementById("HC2").onclick = function() {
		myFunction5()
	};
	document.getElementById("HC3").onclick = function() {
		myFunction6()
	};
	document.getElementById("HC4").onclick = function() {
		myFunction7()
	};
	document.getElementById("HC5").onclick = function() {
		myFunction8()
	};
